...
@mark.it('Loading from bookstore.xml file to object structure, then dumping to XML results in an XML file identical to bookstore.xml')
...
@mark.it('Loading from leaf_without_value.xml to object structure, then dumping to XML results in an XML file identical to leaf_without_value.xml')
def test_pathological():
    test_tree = load_xml_from_file('test_data/leaf_without_value/leaf_without_value.xml')
